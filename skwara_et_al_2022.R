library(tidyverse)
source("code/plot_results.R") # for plotting results
source("code/plot_pred_obs.R") # for plotting results
...
run_model <- function(datafile, # location of the data
  ...
  # load goal function
  if (goalf == "SSQ") source("code/ssq.R")
  if (goalf == "WLS") source("code/wls.R")
  if (goalf == "LikLN") source("code/LikLN.R")
  # load model structure
  source(paste0("code/model_", model, ".R"))
  # read the data
